...
MODEL_NAME         = "gemini-2.5-flash-preview"  # gemini-3-flash-preview per user spec
...
3. The format_3_rl_scenario must include at least one rank=1 (Optimal) and one rank=0 (Passive or Overstep) entry.
...
def main():
    ...
    system_prompt = (
        ...
        "for mathematical delays (EDD Delta) and role boundaries. "
        "Do not hallucinate delays; use the Friction Taxonomy."
    )
